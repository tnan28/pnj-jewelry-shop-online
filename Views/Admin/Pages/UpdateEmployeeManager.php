<div class="AddEmployee" style="display: flex;justify-content: center; flex-direction: column; width: 100%; align-items: center;">
    <div>
        <h1>
            Chỉnh sửa nhân viên <?php echo $data["Employee"]['FULLNAME'] ?>
        </h1>
    </div>
    <form action="">
        <div>
            <div>
                ...
                <input type="text" placeholder="Họ và tên" id="EMPLOYEENAME" value="<?php echo $data["Employee"]['FULLNAME'] ?>">
            </div>
            <p></p>
        </div>
        <div>
            <div>
                ...
                <input type="text" placeholder="EMAIL" id="EMAIL" value="<?php echo $data["Employee"]['EMAIL'] ?>">
        ...
        <div>
            <div>
                ...
                <input type=" text" placeholder="Số điện thoại" id="PHONENUMBER" value="<?php echo $data["Employee"]['PHONENUMBER'] ?>">
        ...
        <div>
            <div>
                ...
                <input type="number" placeholder="Salary" id="SALARY" value="<?php echo ((int)$data["Employee"]['SALARY']) ?>">
            </div>
            <p></p>
        </div>
        <div class="button_Submit_Update">
...
<style>
    ...
    .AddEmployee .button_Submit_Update {
        width: 100%;
        display: flex;
        justify-content: center;
    }

    .AddEmployee .button_Submit_Update button {
        outline: none;
        border: none;
    ...
    .AddEmployee .button_Submit_Update button:hover {
...
<script>
    ...
    document.querySelector('.button_Submit_Update').addEventListener('click', (e) => {
        e.preventDefault();
        validateEMAIL();
        validateFullName();
        validatePhone();
        ...
        if (validateEMAIL() && validateFullName() && validatePhone() && validateSalary()) {
            ...
            $.ajax({
                type: "POST",
                url: "http://localhost:8080/PNJSHOP/Employee/UpdateEmployee/",
                data: JSON.stringify({
                    EmployeeName: EMPLOYEENAME,
                    Email: EMAIL,
                    PhoneNumber: PHONENUMBER,
                    Salary: SALARY,
                    ID: "<?php echo $data['Employee']['EMPLOYEEID'] ?>"
                }),
                dataType: "json",
